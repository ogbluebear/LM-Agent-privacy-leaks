    ...
    for i in tqdm(range(len(data))):
        ...
        if args.step == 'extract_secret':
            ...
            if len(outputs) == 0:
                ...
                for s, o in zip(secrets[actions.iloc[i]['name']], outputs):
            ...
            if len(outputs) == 0:
                ...
                if 'Poor' in output or '0' in output:
                    helpfulness_score = 0
                elif 'Unsatisfactory' in output or '1' in output:
                    helpfulness_score = 1
                elif 'Good' in output or '2' in output:
                    helpfulness_score = 2
                elif 'Excellent' in output or '3' in output:
                    helpfulness_score = 3
                else:
                    helpfulness_score = 0
